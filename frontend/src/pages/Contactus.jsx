...
const Contactus = () => {
  return (
    <>
      ...
      <div className="container mx-auto mt-10 px-4 sm:px-6 lg:px-8 my-section" data-aos="fade-up" data-aos-duration="1000">
        <div className="flex flex-col md:flex-row justify-around space-y-6 md:space-y-0">
          <div className="w-full md:w-1/2 px-6 py-8 bg-white rounded-lg shadow-md border border-orange-500">
            ...
            <div className="bg-[#F15A29] w-full h-auto sm:h-20 rounded-2xl my-section"data-aos="fade-up" data-aos-duration="1000">
          ...
          <div className="w-[370px] h-[350px] px-6 py-8 bg-[#F15A29] rounded-lg shadow-md my-section" data-aos="fade-up" data-aos-duration="1000">
            <h2 className="text-2xl font-bold mb-4 text-white">Contact Us</h2>
            <p className="text-white mb-4">Email</p>
            <p className="text-white mb-4">SS@gmail.com</p>
            <p className="text-white mb-4">Address</p>
            <p className="text-white mb-4">Rishikesh Uttrakhand</p>
  ...
  <div className="w-full h-[600px] rounded-lg shadow-md overflow-hidden mt-10 my-section"data-aos="fade-up" data-aos-duration="1000">
    <iframe
